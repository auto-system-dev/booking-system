                ...
                <div style="padding: 20px;">
                    ...
                    <div style="max-height: 400px; overflow-y: auto;">
                        <table class="bookings-table" style="width: 100%; font-size: 14px; table-layout: fixed; border-collapse: collapse;">
                            ...
                            <thead>
                                <tr>
                                    <th style="padding: 10px 3px; text-align: left; background: #f8f9fa; border-bottom: 2px solid #e0e0e0; font-weight: 600; font-size: 14px;">訂房編號</th>
                                    <th style="padding: 10px 3px; text-align: left; background: #f8f9fa; border-bottom: 2px solid #e0e0e0; font-weight: 600; font-size: 14px;">入住日期</th>
                                    <th style="padding: 10px 3px; text-align: left; background: #f8f9fa; border-bottom: 2px solid #e0e0e0; font-weight: 600; font-size: 14px;">退房日期</th>
                                    <th style="padding: 10px 3px; text-align: left; background: #f8f9fa; border-bottom: 2px solid #e0e0e0; font-weight: 600; font-size: 14px;">房型</th>
                                    <th style="padding: 10px 3px; text-align: right; background: #f8f9fa; border-bottom: 2px solid #e0e0e0; font-weight: 600; font-size: 14px;">金額</th>
                                    <th style="padding: 10px 3px; text-align: center; background: #f8f9fa; border-bottom: 2px solid #e0e0e0; font-weight: 600; font-size: 14px;">狀態</th>
                                </tr>
                            </thead>
                            <tbody>
                                ${customer.bookings && customer.bookings.length > 0 
                                    ? customer.bookings.map(booking => `
                                        <tr style="border-bottom: 1px solid #f0f0f0;">
                                            <td style="padding: 10px 3px; word-break: break-all; font-size: 14px;">${escapeHtml(booking.booking_id)}</td>
                                            <td style="padding: 10px 3px; font-size: 14px;">${escapeHtml(booking.check_in_date)}</td>
                                            <td style="padding: 10px 3px; font-size: 14px;">${escapeHtml(booking.check_out_date)}</td>
                                            <td style="padding: 10px 3px; font-size: 14px;">${escapeHtml(booking.room_type)}</td>
                                            <td style="padding: 10px 3px; text-align: right; font-size: 14px;">NT$ ${(parseInt(booking.total_amount) || 0).toLocaleString()}</td>
                                            <td style="padding: 10px 3px; text-align: center; font-size: 14px;">
